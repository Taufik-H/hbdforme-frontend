<div>
    ...
    <label for="whatsappmodal" class="modal-button btn inline-flex justify-between items-center  w-full lg:w-auto text-gray-500 bg-white rounded-lg border-2 border-gray-200 cursor-pointer  peer-checked:border-blue-600 hover:text-gray-600  peer-checked:text-gray-600 hover:bg-gray-5 hover:bg-white">
    ...
    <input type="checkbox" id="whatsappmodal" class="modal-toggle" />
    <div class="modal">
    <div class="modal-box relative">
        <label for="whatsappmodal" class="btn btn-sm btn-circle absolute right-2 top-2 bg-gray-800 text-white">✕</label>
        <h3 class="text-lg font-bold">Masukan nomer tujuan</h3>
        <div class="mb-4 form-control ">
                     
            <label for="number" class="text-xs font-normal">Your number <span class="text-red-500">*</span></label>
            <input type="text" placeholder="+628 -- ---" id="number" class="pl-2 mt-2 w-full bg-[#F3F3F3] h-10 rounded-lg ring-0 focus:ring-2 focus:ring-purple-800 shadow-none focus:shadow-none focus:outline-none border-none focus:border-none placeholder:text-xs placeholder:font-normal placeholder:p-2 focus:transition ">
        </div>
        <div class="modal-action">
            <button for="whatsappmodal" class="btn btn-primary  text-white">Set Nomor ini</button>
          </div>
    </div>
    </div>
