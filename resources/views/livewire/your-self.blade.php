                 ...
                 {{-- content --}}
                    <div class=" bg-white rounded-lg w-full">
                     <div class="p-5 ">
                         ...
                         <h1 class="text-center mt-5 text-xl font-semibold">Say happy birth day for <span class="text-gray-300">#yourself</span> </h1>
                         {{-- divider --}}
                         <div class="w-full border-b opacity-75 mt-10"></div>
                         <livewire:form-your-self></livewire:form-your-self>
                     </div>
                    </div>
             </div>
