        ...
        <form action="" class="caret-pink-500">
            <div class="flex flex-col md:flex-row justify-between gap-4">
                ...
                <div class="w-full">
                    ...
                    <input datepicker="" id="datepicker" type="text" class="btn bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-purple-500 focus:border-none focus:outline-none focus:ring-2 w-11/12  hover:bg-white datepicker-input" placeholder="Select date">
